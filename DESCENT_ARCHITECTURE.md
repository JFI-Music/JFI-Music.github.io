...
- `drawBats()` — a deterministic 24-bat desktop / 15-bat mobile swarm released one at a time across the Austin scene; four narrow lanes share one shallow, four-turn zigzag just above the skyline, while reduced-motion receives six stationary silhouettes.
